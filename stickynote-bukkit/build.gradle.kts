allprojects {
    ...
    dependencies {
        ...
        api("org.incendo:cloud-core:2.0.0-beta.5")
        api("org.incendo:cloud-paper:2.0.0-beta.5")
        api("org.incendo:cloud-minecraft-extras:2.0.0-beta.5")
        api("org.incendo:cloud-kotlin-extensions:2.0.0-beta.5")
